...
const serverIP = 'iceshnild.20tps.ru';
...
const rules = [{
  ...
  warning:'Если вы его читаете ради неё, то секретное слово <b>"АШ"</b>'
}, {
  num:2.3,
  name:'Маска',
  sub:true,
...
const wiki = [{
  ...
  num:1.1,
  name:'О сервере',
  text:'<b>ICESHNILD</b> — приватный сервер, в котором нельзя гриферить. Здесь проводятся ивенты, есть сюжет, строится спавн с магазинами. Чтобы попасть на StarLand нужно зайти в дискорд сервер и написать заявку. Если вас приняли, напишите ник в соответствующий канал и ждите когда вам напишет бот, что вас добавили в белый список. Далее скопируйте <b>IP</b> на сайте или в дискорде и заходите на сервер',
  
  warning:'На сервер можно зайти с <u>Minecraft Java Edition</u>',
}, {
  mainName:false,
  num:1.2,
  name:'Про дискорд',
  ...
  warning:`<button class="discord-button" onclick="window.open('https://discord.gg/8qm9c7YFk7')
  ...
  text: `Справа — его ник, а то что в скобках — ник в дискорде<br><br>
         <b>Создатель</b> — Arktik (Arktik7)<br><br>
         <b>Тех. Админ</b> — RATcraft (ratatui.ru)<br><br>

         <b>Админы:</b><br>
         <b>1.</b> 3anyda (3anuda4ka)<br><br>

         <b>Помощники:</b><br>
         <b>1.</b> Char/loading... (asleep03709)<br><br>

         <b>Кураторы:</b><br>
         <b>1.</b> Nikola Tesla (kolya_play_)<br>
         <b>2.</b> Brat Pensy (brouther_pensy)<br>
         `,
  warning:false,
}, {
  mainName:'Майнкрафт',
  ...
  num:2.1,
  name:'Сервер',
  text:'У нас есть один сервер — <b>Основа</b>. В них очень много плагинов, а ядро — <i>Paper</i>, которое создает много возможностей без больших лагов',
  warning:false,
},
{
  ...
  num:3.2,
  name:'Онлайн Карта',
  text:'На сервере стоит плагин <i>Dynmap</i>, который позволяет смотреть карту всего Майнкрафт мира в реальном времени на сайте.',
}, {
  mainName:false,
  num:3.3,
  name:'Остальные плагины',
  text:'<b>Armor Stand Editor</b> — Плагин, с которым вы можете редактировать стойки для брони. Чтобы его использовать нажмите палкой на шифте на стойку для брони, а дальше можно самому разобраться.',
}];

const questions = [{
  name:'Как попасть на сервер?',
  num: 1,
  text: `<b>1.</b> Зайдите в наш <a class="s" href="https://discord.gg/8qm9c7YFk7">дискорд</a><br><br>
...
">Скопируйте IP</a></u> и играйте!<br><br>`,
  ...
  num:2,
  text:`На сервере вы можете играть и без модов, но вот <b>рекомендуемые моды:</b><br><br>
  ...
  num:3,
  text:'Сейчас на сервере <b>3-q ctpjy</b>, которое началось, а новый сезон будет в <i>в начале мая 2025 года</i>',
},
{
  name:'Сколько существует сервер?',
  num:4,
  text:'Всего сервер существует <u>около 1 года</u>.',
},
{
  name:'Как пользоваться голосовым чатом?',
  num:5,
  text:'На нашем сервере есть возможность говорить с Java. Для Java нужно просто <u><a onclick="toWiki();">скачать плагин</a></u>.',
  warning:'Готово! Теперь вы слышите всех других игроков, у которых установлен Simple Voice Chat на Java.'
}, {
